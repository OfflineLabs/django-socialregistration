...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('socialregistration_foursquareprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('foursquare_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('socialregistration', ['FoursquareProfile'])


    def backwards(self, orm):
        
        # Deleting model 'FoursquareProfile'
        db.delete_table('socialregistration_foursquareprofile')
    ...
    models = {
        ...
        'socialregistration.foursquareprofile': {
            'Meta': {'object_name': 'FoursquareProfile'},
            'foursquare_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
